...
function Productos() {
  ...
  return (
    <Layout>
      {/* Banner — colores originales intactos */}
      ...
      <section className="container mx-auto px-4 py-8">
        ...
        {/* Tabs de categoría — más grandes y fáciles de tocar */}
        <div className="flex flex-wrap gap-3 justify-center mb-8">
          {tabs.map((tab) => (
            <button
              ...
              className={cn(
                "px-6 py-3 rounded-full text-base font-bold transition-all active:scale-95",
                active === tab.id
                  ? "bg-gradient-fire text-primary-foreground shadow-warm scale-105"
        ...
        {/* Grid de productos */}
        {loading ? (
          // Skeletons — 1 columna en móvil, 2 en tablet, 3 en desktop
          ...
          <div className="rounded-2xl bg-secondary px-6 py-16 text-center text-lg text-muted-foreground">
