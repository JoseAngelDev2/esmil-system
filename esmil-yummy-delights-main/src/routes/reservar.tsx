...
// Only called inside event handlers (client-side), never during render/SSR
function getNow() {
  const now = new Date();
...
function Reservar() {
  ...
  const submitOrder = async () => {
    // getNow() is called here — inside an async click handler,
    // guaranteed client-side only, never during SSR/hydration.
